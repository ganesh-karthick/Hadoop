...
public class Util {
  ...
  private static MemcacheService keycache = MemcacheServiceFactory.getMemcacheService();
	 ...
	 */
  public static void persistEntity(Entity entity , boolean addToCache) {
  ...
  public static Entity findEntity(Key key) {
	 ...
	 */
  public static List<Entity> getListOfEntities(String kind, String searchBy, String searchFor) {
  ...
  public static long getCountOfEntities(String kind, String searchBy, String searchFor){
	  long count = getListOfEntities(kind, searchBy, searchFor).size();
	  return count;
  }
  ...
  public static Iterable<Entity> getAllItems(String keyName) {
	    Iterable<Entity> entities = Util.listEntities(keyName, null, null);
	    return entities;
	  }
}